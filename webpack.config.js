...
const bitrixPathImages = buildConfig.bitrixPath.images;
const bitrixPathFonts = buildConfig.bitrixPath.fonts;
                ...
                use: [
                    {
                        ...
                        options: {
                            name: '[name].[ext]',
                            outputPath: '/fonts/',
                            publicPath: isProd ? bitrixPathFonts : '../fonts/'
                        }
                    }
                ]
            },
                ...
                use: [
                    {
                        ...
                        options: {
                            name: '[name].[ext]',
                            outputPath: '/images/',
                            publicPath: isProd ? bitrixPathImages : '/images/'
                        }
                    }
                ]
            }
